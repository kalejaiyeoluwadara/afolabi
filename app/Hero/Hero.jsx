  ...
  return (
    <main className="sm:flex-center  w-screen overflow-hidden ">
      <div className="flex-center  flex-col relative ">
        ...
        <p
          id="h1text"
          className="uppercase px-5 font-clashb font-bold  opacity-1  sm:text-[64px] leading-[2rem] text-[28px] sm:mt-[60px] w-full sm:w-[952px] sm:leading-[1.2] text-start sm:text-center text-black "
        >
        ...
        <Link
          href={"#collections"}
          // className="sm:w-auto bg-red-300 w-full sm:block flex-center "
        >
          <div
            id="foot"
